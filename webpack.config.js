...
module.exports = {
  ...
  plugins: [
    new webpack.optimize.CommonsChunkPlugin(/* chunkName= */"vendor", /* filename= */"vis_component.deps.js"),
    new ExtractTextPlugin("vis_component.css")
  ]
};
